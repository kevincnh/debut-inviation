  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1566174053879-31528523f8ae?w=2000&h=2400&fit=crop&auto=format&q=80"
  ...
  return (
    <section className="relative py-40 overflow-hidden bg-background">
      ...
      <div className="absolute inset-0 opacity-20">
        <img
          src="https://images.unsplash.com/photo-1549417229-aa67d3263c09?w=2000&h=1000&fit=crop&auto=format"
          alt="Elegant texture"
